...
#line 29 "parser.y"
                    { printf("+ "); (yyval.number) = (yyvsp[-2].number) + (yyvsp[0].number); }
...
#line 40 "parser.y"
           { printf("%.2f ", (yyvsp[0].number)); (yyval.number) = (yyvsp[0].number); }
